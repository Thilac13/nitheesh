  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-lg bg-codez-elements-background dark:bg-codez-elements-background-depth-2 border border-codez-elements-borderColor dark:border-codez-elements-borderColor hover:border-codez-elements-borderColorActive/70 dark:hover:border-codez-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-ph:github-logo text-codez-elements-item-contentAccent dark:text-codez-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary">
              GitHub Connection
            </div>
          </div>
          {diagnosticResults ? (
            <>
              ...
              {diagnosticResults.localStorage.hasGithubConnection && (
                <>
                  <div className="text-xs text-codez-elements-textSecondary dark:text-codez-elements-textSecondary mt-2 flex items-center gap-1.5">
                    <div className="i-ph:user w-3.5 h-3.5 text-codez-elements-item-contentAccent dark:text-codez-elements-item-contentAccent" />
                    User: {diagnosticResults.localStorage.githubConnectionParsed?.user?.login || 'N/A'}
                  </div>
                  <div className="text-xs text-codez-elements-textSecondary dark:text-codez-elements-textSecondary mt-2 flex items-center gap-1.5">
                    <div className="i-ph:check-circle w-3.5 h-3.5 text-codez-elements-item-contentAccent dark:text-codez-elements-item-contentAccent" />
                    API Status:{' '}
                    <Badge
                      variant={
              ...
              {!diagnosticResults.localStorage.hasGithubConnection && (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="mt-auto self-start hover:bg-codez-elements-item-backgroundActive/10 hover:text-codez-elements-textPrimary dark:hover:bg-codez-elements-item-backgroundActive/10 dark:hover:text-codez-elements-textPrimary transition-colors"
                >
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-sm text-codez-elements-textSecondary dark:text-codez-elements-textSecondary flex items-center gap-2">
        ...
        <div className="p-4 rounded-lg bg-codez-elements-background dark:bg-codez-elements-background-depth-2 border border-codez-elements-borderColor dark:border-codez-elements-borderColor hover:border-codez-elements-borderColorActive/70 dark:hover:border-codez-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-codez:netlify text-codez-elements-item-contentAccent dark:text-codez-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary">
              Netlify Connection
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-codez-elements-background dark:bg-codez-elements-background-depth-2 border border-codez-elements-borderColor dark:border-codez-elements-borderColor hover:border-codez-elements-borderColorActive/70 dark:hover:border-codez-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-si:vercel text-codez-elements-item-contentAccent dark:text-codez-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary">
              Vercel Connection
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-codez-elements-background dark:bg-codez-elements-background-depth-2 border border-codez-elements-borderColor dark:border-codez-elements-borderColor hover:border-codez-elements-borderColorActive/70 dark:hover:border-codez-elements-borderColorActive/70 transition-all duration-200 h-[180px] flex flex-col">
          <div className="flex items-center gap-2">
            <div className="i-si:supabase text-codez-elements-item-contentAccent dark:text-codez-elements-item-contentAccent w-4 h-4" />
            <div className="text-sm font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary">
              Supabase Connection
            </div>
          </div>
          {diagnosticResults ? (
            <>
              ...
              {diagnosticResults.localStorage.hasSupabaseConnection && (
                <>
                  <div className="text-xs text-codez-elements-textSecondary dark:text-codez-elements-textSecondary mt-2 flex items-center gap-1.5 truncate">
                    <div className="i-ph:link w-3.5 h-3.5 text-codez-elements-item-contentAccent dark:text-codez-elements-item-contentAccent flex-shrink-0" />
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <Button
          ...
          variant="outline"
          className="flex items-center gap-2 hover:bg-codez-elements-item-backgroundActive/10 hover:text-codez-elements-textPrimary dark:hover:bg-codez-elements-item-backgroundActive/10 dark:hover:text-codez-elements-textPrimary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <Collapsible open={showDetails} onOpenChange={setShowDetails} className="w-full">
            <CollapsibleTrigger className="w-full">
              <div className="flex items-center justify-between p-4 rounded-lg bg-codez-elements-background dark:bg-codez-elements-background-depth-2 border border-codez-elements-borderColor dark:border-codez-elements-borderColor hover:border-codez-elements-borderColorActive/70 dark:hover:border-codez-elements-borderColorActive/70 transition-all duration-200">
                ...
                <ChevronDownIcon
                  className={classNames(
                    'w-4 h-4 transform transition-transform duration-200 text-codez-elements-textSecondary dark:text-codez-elements-textSecondary',
            ...
            <CollapsibleContent className="overflow-hidden">
              <div className="p-4 mt-2 rounded-lg bg-codez-elements-background-depth-2 dark:bg-codez-elements-background-depth-1 border border-codez-elements-borderColor dark:border-codez-elements-borderColor">
                <pre className="text-xs overflow-auto max-h-96 text-codez-elements-textSecondary dark:text-codez-elements-textSecondary">
