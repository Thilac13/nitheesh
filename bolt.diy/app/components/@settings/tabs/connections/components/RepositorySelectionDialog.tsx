    ...
    <RepositoryDialogContext.Provider value={{ setShowAuthDialog }}>
      ...
      >
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 w-[90vw] md:w-[650px] max-h-[85vh] overflow-hidden bg-white dark:bg-codez-elements-background-depth-1 rounded-xl shadow-xl z-[51] border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark">
            {/* Header */}
            <div className="p-5 border-b border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <Dialog.Title className="text-lg font-semibold text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark">
              ...
              <Dialog.Close
                ...
                className={classNames(
                  ...
                  'text-codez-elements-textTertiary hover:text-codez-elements-textPrimary',
                  'dark:text-codez-elements-textTertiary-dark dark:hover:text-codez-elements-textPrimary-dark',
                  'hover:bg-codez-elements-background-depth-2 dark:hover:bg-codez-elements-background-depth-3',
                  'focus:outline-none focus:ring-2 focus:ring-codez-elements-borderColor dark:focus:ring-codez-elements-borderColor-dark',
                )}
              >
            ...
            {/* Auth Info Banner */}
            <div className="p-4 border-b border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark flex items-center justify-between bg-gradient-to-r from-codez-elements-background-depth-2 to-codez-elements-background-depth-1 dark:from-codez-elements-background-depth-3 dark:to-codez-elements-background-depth-2">
              <div className="flex items-center gap-2">
                <span className="i-ph:info text-blue-500" />
                <span className="text-sm text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark">
            ...
            <div className="p-5">
              {/* Tabs */}
              <div className="mb-6">
                <div className="bg-[#f0f0f0] dark:bg-[#1e1e1e] rounded-lg overflow-hidden border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark">
                  <div className="flex">
                    <button
                      ...
                      className={classNames(
                        ...
                        activeTab === 'my-repos'
                          ? 'bg-[#e6e6e6] dark:bg-[#2a2a2a] text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark'
                          : 'bg-[#f0f0f0] dark:bg-[#1e1e1e] text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark hover:bg-[#e6e6e6] dark:hover:bg-[#2a2a2a]/50',
                      )}
                    >
                      My Repos
                    </button>
              ...
              {activeTab === 'url' ? (
                <div className="space-y-5">
                  <div className="bg-gradient-to-br from-codez-elements-background-depth-1 to-codez-elements-background-depth-1 dark:from-codez-elements-background-depth-2-dark dark:to-codez-elements-background-depth-2-dark p-5 rounded-xl border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark">
                    <h3 className="text-base font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark mb-3 flex items-center gap-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="w-full pl-10 py-3 border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      />
                    </div>

                    <div className="mt-3 text-xs text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark bg-white/50 dark:bg-codez-elements-background-depth-4/50 p-3 rounded-lg border border-codez-elements-borderColor/30 dark:border-codez-elements-borderColor-dark/30 backdrop-blur-sm">
                      <p className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <br />
                          <span className="text-codez-elements-textTertiary dark:text-codez-elements-textTertiary-dark">
                  ...
                  <div className="flex items-center gap-3 text-sm text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark">
                    <div className="h-px flex-grow bg-codez-elements-borderColor dark:bg-codez-elements-borderColor-dark"></div>
                ...
                <>
                  {activeTab === 'search' && (
                    <div className="space-y-5 mb-5">
                      <div className="bg-gradient-to-br from-blue-500/5 to-cyan-500/5 p-5 rounded-xl border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark">
                        <h3 className="text-base font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark mb-3 flex items-center gap-2">
                        ...
                        <div className="flex gap-2">
                          <div className="flex-1">
                            <SearchInput
                              ...
                              className="py-3 bg-white dark:bg-codez-elements-background-depth-4 border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
                              loading={isLoading}
                            />
                          </div>
                          <motion.button
                            onClick={() => setFilters({})}
                            className="px-3 py-2 rounded-lg bg-white dark:bg-codez-elements-background-depth-4 text-codez-elements-textSecondary hover:text-codez-elements-textPrimary border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark shadow-sm"
                        ...
                        <div className="mt-3">
                          <div className="text-xs text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark mb-2">
                            Filters
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <div className="relative col-span-3 md:col-span-1">
                              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-codez-elements-textTertiary dark:text-codez-elements-textTertiary-dark">
                              ...
                              <input
                                ...
                                className="w-full pl-8 px-3 py-2 text-sm rounded-lg bg-white dark:bg-codez-elements-background-depth-4 border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark focus:outline-none focus:ring-2 focus:ring-blue-500"
                              />
                            </div>
                            <div className="relative">
                              <div className="absolute left-2 top-1/2 -translate-y-1/2 text-codez-elements-textTertiary dark:text-codez-elements-textTertiary-dark">
                  ...
                  <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    {selectedRepository ? (
                      <div className="space-y-5 bg-gradient-to-br from-purple-500/5 to-blue-500/5 p-5 rounded-xl border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <motion.button
                              onClick={() => setSelectedRepository(null)}
                              className="p-2 rounded-lg hover:bg-white dark:hover:bg-codez-elements-background-depth-4 text-codez-elements-textSecondary hover:text-codez-elements-textPrimary shadow-sm"
                            ...
                            <div>
                              <h3 className="font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark text-lg">
                                {selectedRepository.name}
                              </h3>
                              <p className="text-xs text-codez-elements-textTertiary dark:text-codez-elements-textTertiary-dark flex items-center gap-1">
                        ...
                        {selectedRepository.description && (
                          <div className="bg-white/50 dark:bg-codez-elements-background-depth-4/50 p-3 rounded-lg border border-codez-elements-borderColor/30 dark:border-codez-elements-borderColor-dark/30 backdrop-blur-sm">
                            <p className="text-sm text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark">
                              {selectedRepository.description}
                            </p>
                          </div>
                        ...
                        <div className="pt-3 border-t border-codez-elements-borderColor/30 dark:border-codez-elements-borderColor-dark/30">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="i-ph:git-branch w-4 h-4 text-purple-500" />
                            <label className="text-sm font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark">
                              Select Branch
                            </label>
                          </div>
                          <select
                            ...
                            className="w-full px-3 py-3 rounded-lg bg-white dark:bg-codez-elements-background-depth-4 border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm"
                          >
                            {branches.map((branch) => (
                              <option
                                key={branch.name}
                                value={branch.name}
                                className="bg-white dark:bg-codez-elements-background-depth-4 text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark"
                              >
                        ...
                        <div className="flex items-center gap-3 text-sm text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark">
                          <div className="h-px flex-grow bg-codez-elements-borderColor/30 dark:bg-codez-elements-borderColor-dark/30"></div>
                          <span>Ready to import?</span>
                          <div className="h-px flex-grow bg-codez-elements-borderColor/30 dark:bg-codez-elements-borderColor-dark/30"></div>
                        </div>
