...
export default function GitHubConnection() {
  ...
  return (
    <motion.div
      className="bg-codez-elements-background dark:bg-codez-elements-background border border-codez-elements-borderColor dark:border-codez-elements-borderColor rounded-lg"
    ...
    >
      <div className="p-6 space-y-6">
        ...
        {!connection.user && (
          <div className="text-xs text-codez-elements-textSecondary bg-codez-elements-background-depth-1 dark:bg-codez-elements-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              <span className="i-ph:lightbulb w-3.5 h-3.5 text-codez-elements-icon-success dark:text-codez-elements-icon-success" />
          ...
          <div>
            ...
            <select
              ...
              className={classNames(
                ...
                'bg-codez-elements-background-depth-1 dark:bg-codez-elements-background-depth-1',
                'border border-codez-elements-borderColor dark:border-codez-elements-borderColor',
                'text-codez-elements-textPrimary dark:text-codez-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-codez-elements-item-contentAccent dark:focus:ring-codez-elements-item-contentAccent',
                'disabled:opacity-50',
              )}
            >
              ...
              <div className="flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="flex items-center gap-2 hover:bg-codez-elements-item-backgroundActive/10 hover:text-codez-elements-textPrimary dark:hover:text-codez-elements-textPrimary transition-colors"
                  >
        ...
        {connection.user && connection.stats && (
          <div className="mt-6 border-t border-codez-elements-borderColor dark:border-codez-elements-borderColor pt-6">
            <div className="flex items-center gap-4 p-4 bg-codez-elements-background-depth-1 dark:bg-codez-elements-background-depth-1 rounded-lg mb-4">
              <img
                src={connection.user.avatar_url}
                alt={connection.user.login}
                className="w-12 h-12 rounded-full border-2 border-codez-elements-item-contentAccent dark:border-codez-elements-item-contentAccent"
              />
              <div>
                <h4 className="text-sm font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary">
            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between p-4 rounded-lg bg-codez-elements-background dark:bg-codez-elements-background-depth-2 border border-codez-elements-borderColor dark:border-codez-elements-borderColor hover:border-codez-elements-borderColorActive/70 dark:hover:border-codez-elements-borderColorActive/70 transition-all duration-200">
                  <div className="flex items-center gap-2">
                    <div className="i-ph:chart-bar w-4 h-4 text-codez-elements-item-contentAccent" />
                    <span className="text-sm font-medium text-codez-elements-textPrimary">GitHub Stats</span>
                  </div>
                  <div
                    className={classNames(
              ...
              <CollapsibleContent className="overflow-hidden">
                <div className="space-y-4 mt-4">
                  {/* Languages Section */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-codez-elements-textPrimary mb-3">Top Languages</h4>
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(connection.stats.languages)
                        ...
                        .map(([language]) => (
                          <span
                            key={language}
                            className="px-3 py-1 text-xs rounded-full bg-codez-elements-sidebar-buttonBackgroundDefault text-codez-elements-sidebar-buttonText"
                          >
                            {language}
                          </span>
                        ))}
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex flex-col p-3 rounded-lg bg-codez-elements-background-depth-2 dark:bg-codez-elements-background-depth-2 border border-codez-elements-borderColor dark:border-codez-elements-borderColor"
                      >
                        <span className="text-xs text-codez-elements-textSecondary">{stat.label}</span>
                        <span className="text-lg font-medium text-codez-elements-textPrimary">{stat.value}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-4">
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-sm font-medium text-codez-elements-textPrimary mb-2">Repository Stats</h5>
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-codez-elements-textPrimary mb-2">Contribution Stats</h5>
                          ...
                          {[
                            {
                              ...
                              icon: 'i-ph:star',
                              iconColor: 'text-codez-elements-icon-warning',
                            },
                            {
                              label: 'Forks',
                              value: connection.stats.forks || 0,
                              icon: 'i-ph:git-fork',
                              iconColor: 'text-codez-elements-icon-info',
                            },
                            {
                              label: 'Followers',
                              value: connection.stats.followers || 0,
                              icon: 'i-ph:users',
                              iconColor: 'text-codez-elements-icon-success',
                            },
                          ].map((stat, index) => (
                            <div
                              key={index}
                            ...
                            >
                              <span className="text-xs text-codez-elements-textSecondary">{stat.label}</span>
                              <span className="text-lg font-medium text-codez-elements-textPrimary flex items-center gap-1">
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-codez-elements-textPrimary mb-2">Gists</h5>
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            {
                              label: 'Public',
                      ...
                      <div className="pt-2 border-t border-codez-elements-borderColor">
                        <span className="text-xs text-codez-elements-textSecondary">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-codez-elements-textPrimary">Recent Repositories</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {connection.stats.repos.map((repo) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group block p-4 rounded-lg bg-codez-elements-background-depth-1 dark:bg-codez-elements-background-depth-1 border border-codez-elements-borderColor dark:border-codez-elements-borderColor hover:border-codez-elements-borderColorActive dark:hover:border-codez-elements-borderColorActive transition-all duration-200"
                        >
                          <div className="space-y-3">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2">
                                <div className="i-ph:git-branch w-4 h-4 text-codez-elements-icon-tertiary" />
                                <h5 className="text-sm font-medium text-codez-elements-textPrimary group-hover:text-codez-elements-item-contentAccent transition-colors">
                                  {repo.name}
                                </h5>
                              </div>
                              <div className="flex items-center gap-3 text-xs text-codez-elements-textSecondary">
                                <span className="flex items-center gap-1" title="Stars">
                                  <div className="i-ph:star w-3.5 h-3.5 text-codez-elements-icon-warning" />
                                  {repo.stargazers_count.toLocaleString()}
                                </span>
                                <span className="flex items-center gap-1" title="Forks">
                                  <div className="i-ph:git-fork w-3.5 h-3.5 text-codez-elements-icon-info" />
                            ...
                            {repo.description && (
                              <p className="text-xs text-codez-elements-textSecondary line-clamp-2">
                                {repo.description}
                              </p>
                            )}
                            ...
                            <div className="flex items-center gap-3 text-xs text-codez-elements-textSecondary">
                              ...
                              <span className="flex items-center gap-1 ml-auto group-hover:text-codez-elements-item-contentAccent transition-colors">
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-codez-elements-textSecondary">Loading...</span>
      </div>
    </div>
  );
}
