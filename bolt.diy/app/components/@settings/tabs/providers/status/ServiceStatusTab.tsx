      ...
      >
        <div className="flex items-center justify-between gap-2 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-codez-elements-textPrimary">Service Status</h4>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={classNames(
                ...
                'bg-codez-elements-background-depth-3 hover:bg-codez-elements-background-depth-4',
        ...
        <div className="p-4 bg-codez-elements-background-depth-2 rounded-lg">
          <h5 className="text-sm font-medium text-codez-elements-textPrimary mb-2">Test API Key</h5>
        ...
        {loading && serviceStatuses.length === 0 ? (
          <div className="text-center py-8 text-codez-elements-textSecondary">Loading service statuses...</div>
        ) : (
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-codez-elements-textPrimary">{service.provider}</h4>
                        <div className="space-y-1">
                          <p className="text-xs text-codez-elements-textSecondary">
                            Last checked: {new Date(service.lastChecked).toLocaleTimeString()}
                          </p>
                          {service.responseTime && (
                            <p className="text-xs text-codez-elements-textTertiary">
                              Response time: {Math.round(service.responseTime)}ms
                            </p>
                          )}
                          {service.message && (
                            <p className="text-xs text-codez-elements-textTertiary">{service.message}</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  {service.incidents && service.incidents.length > 0 && (
                    <div className="mt-2 border-t border-codez-elements-borderColor pt-2">
                      <p className="text-xs font-medium text-codez-elements-textSecondary mb-1">Recent Incidents:</p>
                      <ul className="text-xs text-codez-elements-textTertiary space-y-1">
