    ...
    >
      <div className="flex items-center gap-4">
        <div className="cursor-grab">
          <div className="i-ph:dots-six-vertical w-4 h-4 text-codez-elements-textSecondary" />
        </div>
        <div>
          <div className="font-medium text-codez-elements-textPrimary">{TAB_LABELS[tab.id]}</div>
          {showControls && (
      ...
      {showControls && !tab.locked && (
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-sm text-codez-elements-textSecondary">Visible</label>
          </div>
          <div className="flex items-center gap-2">
            <label className="text-sm text-codez-elements-textSecondary">User</label>
            <Switch
            ...
            />
            <label className="text-sm text-codez-elements-textSecondary">Dev</label>
          </div>
        </div>
      )}
    </motion.div>
