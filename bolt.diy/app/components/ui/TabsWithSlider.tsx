        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-codez-elements-background-depth-2 dark:bg-codez-elements-background-depth-3 text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark hover:bg-codez-elements-background-depth-3 dark:hover:bg-codez-elements-background-depth-4 border border-codez-elements-borderColor dark:border-codez-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
