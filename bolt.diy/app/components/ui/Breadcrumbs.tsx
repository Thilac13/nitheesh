      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-codez-elements-textPrimary dark:text-codez-elements-textPrimary-dark'
              : 'text-codez-elements-textSecondary dark:text-codez-elements-textSecondary-dark hover:text-codez-elements-textPrimary dark:hover:text-codez-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-codez-elements-textTertiary dark:text-codez-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
