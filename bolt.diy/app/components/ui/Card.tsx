  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-codez-elements-borderColor bg-codez-elements-background-depth-1 text-codez-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-codez-elements-textSecondary', className)} {...props} />;
  },
);
