      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-codez-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-codez-elements-item-backgroundAccent hover:bg-codez-elements-artifacts-backgroundHover"
