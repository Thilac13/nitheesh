...
<artifact_info>
  ...
  - Use \`<codezArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<codezAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<codezArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<codezAction>\` tags with appropriate \`type\` attribute:
