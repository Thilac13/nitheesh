...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out codez artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <codez', 'Foo bar '],
      ['Foo bar <codeza', 'Foo bar <codeza'],
      ['Foo bar <codezA', 'Foo bar '],
      ['Foo bar <codezArtifacs></codezArtifact>', 'Foo bar <codezArtifacs></codezArtifact>'],
      ['Before <oltArtfiact>foo</codezArtifact> After', 'Before <oltArtfiact>foo</codezArtifact> After'],
      ['Before <codezArtifactt>foo</codezArtifact> After', 'Before <codezArtifactt>foo</codezArtifact> After'],
    ])('should correctly parse chunks and strip out codez artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <codezArtifact title="Some title" id="artifact_1">foo bar</codezArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <codezArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</codezArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</codezArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</codezArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <codezArtifact title="Some title" id="artifact_1">foo</codezArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <codezArtifact title="Some title" id="artifact_1"><codezAction type="shell">npm install</codezAction></codezArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <codezArtifact title="Some title" id="artifact_1"><codezAction type="shell">npm install</codezAction><codezAction type="file" filePath="index.js">some content</codezAction></codezArtifact> After',
        {
          output: 'Before  After',
